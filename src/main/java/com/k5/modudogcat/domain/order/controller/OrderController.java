...
public class OrderController {
    ...
    public ResponseEntity postOrder(@RequestBody @Valid OrderDto.Post postDto){
        ...
        Long orderId = orderService.postOrder(postDto);
    ...
    public ResponseEntity patchOrder(@PathVariable("order-id") Long orderId,
        ...
        OrderDto.Response response = orderService.patchOrder(patchDto, userId);
    ...
    public ResponseEntity getOrder(@PathVariable("order-id") Long orderId){
        Long userId = authenticationService.getUserIdByToken();
        OrderDto.Response response = orderService.getOrder(orderId, userId);
    ...
    public ResponseEntity findBuyerOrders(Pageable pageable){
        Long userId = authenticationService.getUserIdByToken();
        OrderDto.PagingResponse pagingResponse = orderService.findBuyerOrders(pageable, userId);
        List<OrderDto.Response> responses = pagingResponse.getResponses();
        Page<Order> pageOrders = pagingResponse.getPageOrders();
